...
if not os.path.exists("results_ce05"):
    os.mkdir("results_ce05")
...
for iter in range(5):
    ...
    for k in tqdm(range(0, num_batches)):
        ...
        for t in range(max_iterations):
            ...
            loss = nn.CrossEntropyLoss(reduction='sum')(logits/0.5, labels)
    ...
    file_name = "results_ce05/%d_inc_v3.npy" % iter
    ...
    file_name = "results_ce05/%d_resnet50.npy" % iter
    ...
    file_name = "results_ce05/%d_dense121.npy" % iter
    ...
    file_name = "results_ce05/%d_vgg16.npy" % iter
